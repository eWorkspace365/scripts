...
################################################################
$AdminSiteURL = "boomuitgevers-admin.sharepoint.com" 
$SiteCollAdmin = "ict@boom.nl"
...
{
    Connect-PnPOnline -Url $SiteURL -ClientId "397efc0e-2b67-4f37-b510-85dccfbe20a6" -Thumbprint "06636934738C896A73194F6854DD55E0940AD58D" -Tenant "boomuitgevers.onmicrosoft.com" -ErrorAction Stop
...
try {
    Connect-PnPOnline -Url $AdminSiteURL -ClientId "397efc0e-2b67-4f37-b510-85dccfbe20a6" -Thumbprint "06636934738C896A73194F6854DD55E0940AD58D" -Tenant "boomuitgevers.onmicrosoft.com"
